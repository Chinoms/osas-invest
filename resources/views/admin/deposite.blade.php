                            ...
                            <div class="buy-sell-widget">
                                ...
                                <div class="tab-content tab-content-default">
                                    <div class="tab-pane fade show active" id="buy" role="tabpanel">
                                        ...
                                        @endif
                                        <form method="POST" name="myform" class="currency_validate" action="/cashier/deposite">
                                            @csrf
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <select id="depositSelect" name="portfolio" class="form-control">

                                                        <option value="{{ $portfolio->id }}" selected=""> Portfolio 0 ||
                                                            {{ $portfolio->investment_amount }} BTC
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" step="any" min="0"
                                                        id="btcAmountDeposit" name="amount" class="form-control"
                                                        placeholder="0.078 BTC">
                                                </div>
                                            </div>
                                            <button type="submit" name="submit"
                                                class="btn btn-primary btn-block waves-effect"><i
                                                    class="fa fa-arrow-down">&nbsp;</i>Deposit
                                                Now</button>
                                        </form>
                                    </div>
                                </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        <tbody>
                                            <tr>
                                                <td>Balance</td>
                                                <td id="folioBalance">{{ $portfolio->transaction->where('type', 0)->sum('amount') - $portfolio->transaction->where('type', 1)->sum('amount') }}
                                                    BTC</td>
                                            </tr>
                                            <tr>
                                                <td>Setup Date</td>
